...
user_profile = {
    ...
    'dry_review': 1 if skin_type == 'Dry' or skin_type == 'Combination' else 0, 
    ...
    'acne_review': 1 if user_conditions.get('Acne', True) or skin_type == 'Oily' or skin_type == 'Combination' else 0,
    ...
    'coverage_review': 1 if coverage in ['Medium', 'Full'] else 0, 
